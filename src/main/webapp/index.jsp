...
<style>
/* =========================================================
   NEXUSSHOP — YELLOW + RED PREMIUM UI
   ========================================================= */
...
:root {
    ...
    --shadow:
        0 10px 35px rgba(83, 42, 10, .08);

    --shadow-hover:
        0 20px 55px rgba(196, 71, 25, .18);
...
header {
    ...
    border-bottom:
        1px solid rgba(230,57,39,.08);

    box-shadow:
        0 5px 25px rgba(75,35,10,.05);
}
