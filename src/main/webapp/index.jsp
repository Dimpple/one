...
<head>
    ...
    <title>NexusShop · pink & blue</title>
    <!-- Fonts & Icons -->
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Playfair+Display:wght@700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" crossorigin="anonymous">
    <style>
        /* ========== ROOT — PINKISH BLUE VARIABLES ========== */
        :root {
            --bg: #f6f3fc;
            --bg-card: #ffffff;
            --primary: #172a4a;
            ...
            --radius: 16px;
            --radius-sm: 10px;
            --shadow: 0 4px 24px rgba(23, 42, 74, 0.06);
            --shadow-hover: 0 12px 48px rgba(23, 42, 74, 0.12);
        ...
        * {
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 24px rgba(224, 106, 138, 0.35);
        }
        .btn-secondary {
        ...
        .btn-secondary:hover {
            ...
            transform: translateY(-2px);
            box-shadow: 0 8px 24px rgba(23, 42, 74, 0.25);
        }
        .btn-outline {
            background: transparent;
            color: var(--primary);
            border-color: rgba(23, 42, 74, 0.15);
        }
        .btn-outline:hover {
            background: var(--primary);
            color: #fff;
        ...
        header {
            ...
            border-bottom: 1px solid rgba(23, 42, 74, 0.04);
        }
        .header-inner {
            display: flex;
            align-items: center;
        ...
        .search-wrap:focus-within {
            border-color: var(--accent);
            background: #fff;
            box-shadow: 0 0 0 4px rgba(224, 106, 138, 0.12);
        }
        .search-wrap input {
            border: 0;
            background: transparent;
        ...
        #mobileMenu {
            display: none;
            background: #fff;
            border-top: 1px solid rgba(23, 42, 74, 0.04);
            padding: 12px 0 20px;
        }
        #mobileMenu ul {
            list-style: none;
        ...
        .hero {
            ...
            overflow: hidden;
            margin: 20px 24px 0;
            background: linear-gradient(145deg, #1b2b4a 0%, #2c3f64 100%);
        }
        .hero::before {
            content: '';
            position: absolute;
        ...
        .hero .badge {
            ...
            background: rgba(224, 106, 138, 0.25);
            color: #fbc4d3;
            padding: 4px 16px;
            border-radius: 999px;
            font-weight: 600;
